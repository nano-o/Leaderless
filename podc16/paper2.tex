...
For example, consider $h$ such that $V\left( h \right)=\aset{c_1,c_2,c_3,c_4}$ and $E\left( h \right)=\aset{\left( c_1,c_2 \right),\left( c_2,c_1 \right),\left( c_1,c_3 \right)}$. Then $V\left(\hat{h}\right) = \aset{\aset{c_1,c_2},\aset{c_3},\aset{c_4}}$ and $E\left( \hat{h} \right)=\aset{\left( \aset{c_1,c_2},\aset{c_3} \right)}$. We will use $h$ as an example in the rest of the section.
...
For example, if $f\left[ \set{c_1,c_2} \right] = \aseq{c_2,c_1}$ then $\aseq{c_2,c_1,c_3,c_4}$ is a linearization of $h$ but $\aseq{c_1,c_2,c_3,c_4}$ is not and neither is $\aseq{c_3,c_2,c_1,c_4}$
...
For example, if $V\left( h' \right)=\aset{c_1,c_2,c_4}$ and $E\left( h' \right)=\aset{\left( c_1,c_2 \right),\left( c_2,c_1 \right)}$ then $h'\leq h$. However, if $V\left( h'' \right)=\aset{c_1,c_3,c_4}$ and $E\left( h \right)=\aset{\left( c_1,c_3 \right)}$ then $\left( h'',h \right)\notin \leq$.
